...
<html lang="en">
	<head>
        ...
        <script type="text/javascript" src="${path}/assets/js/AvoidingBackButton.js"> </script>
       ...
       <jsp:include page="../../jsp/common/corporaterelation_menu.jsp"></jsp:include>
		...
		<h4 class="pink">
			<i class="ace-icon fa fa-hand-o-right icon-animated-hand-pointer blue"></i>
				 <b class="blue" >Client MAnagement</b> 
		</h4>
...
<div class='row' >
    <div style='bgcolor:green'>
      ...
      <span style='color:green'>
        ...
        <div class="alert alert-success" style="Text-align:Left; width:30%;"><%=request.getAttribute("msg")%> </div>
                                               <%} %>
      </span>
   </div> 
...
<div class="col-md-8" style="text-align: center; padding-top: 5px;">
	<div id='success-msg' class="success_msg" style="width: 40%;"></div>
</div>
...
<div class="col-md-10">
    ...
    <button type="button" class="btn btn-info" data-toggle="modal"
		 data-target="#addNewClientDetails" onclick='addNewClients()'>Add Client</button> <hr />
</div>
	</div>
	    </div>
	
<div style="border: lightgray 1px solid; box-shadow: 5px 5px 5px lightgray; width:98%; text-align: center;">
...
<div class="modal-content" style="background-color:#E5E4E2;">
	...
	<form action="<%=request.getContextPath()%>/AddClientManagementAction" method="post" enctype="multipart/form-data"
		 class="form-horizontal" name="clientDetails" id="Add_form" >


<div class="form-group">
	<label class="control-label col-sm-2" for="ClientName">Client Name:<span style="color:red;">*</span></b></label>
		<div class="col-sm-3">
		    <input type="text" class="form-control" id="ClientName"  onblur="checkDuplicacy()" name="ClientName" placeholder="Enter Client Name" required="required">
...
<div class="form-group">
	<label class="control-label col-sm-2" for="s">Client Image:<span style="color:red;">*</span></b></label>
		<div class="col-sm-3">
			<input type="file" class="form-control" id="avatar" name="img" placeholder="Enter image" required="required">
...
<div class="form-group">
    <label class="control-label col-sm-2" for="Description">Description:<span style="color:red;">*</span></b></label>
		<div class="col-sm-3">
			<input type="text" class="form-control" id="description_add" name="Description" placeholder="Enter Description" required="required">
...
<div class="form-group">
	<label class="control-label col-sm-2" for="Company_Level_Id">Company Level:<span style="color:red;">*</span></b></label>
		<div class="col-sm-3">
			<select class="form-control" id="Company_Level" name="Company_Level_Id" required="required"></select>
...
<div class="form-group">
	<label class="control-label col-sm-2" for="contact_person_name">Contact Person Name:<span style="color:red;">*</span></b></label>
		<div class="col-sm-3">
...
<div class="form-group">
   <label class="control-label col-sm-2" for="contact_person_mobile_no">Contact Person Mobile No:<span style="color:red;">*</span></b></label>
	   <div class="col-sm-3">
			<input type="text" class="form-control" id="contact_person_mobile_no" name="contact_person_mobile_no"
...
<div class="form-group">
	<label class="control-label col-sm-2" for="contact_person_mail">Contact Person Mail:<span style="color:red;">*</span></b></label>
		<div class="col-sm-3">
			 <input type="text" class="form-control" id="contact_person_mail" name="contact_person_mail"
...
<div class="form-group">
	<label class="control-label col-sm-4">Enter Client Address Details:</label>
</div>
...
<div class="form-group">
	<label class="control-label col-sm-2" for="country">Country:<span style="color:red;">*</span></b></label>
		 <div class="col-sm-3">
			  <select class="form-control" id="country" name="country" onchange="setCountryId()" placeholder="Enter Country" required="required">
...
<div class="form-group">
	<label class="control-label col-sm-2" for="state">State:<span style="color:red;">*</span></b></label>
		 <div class="col-sm-3">
			 <select class="form-control" id="state" name="state" onchange="setStateId()" placeholder="Select State" required="required"></select>
...
<div class="form-group">
	<label class="control-label col-sm-2" for="city">City:<span style="color:red;">*</span></b></label>
		<div class="col-sm-3">
			<select class="form-control" id="city" name="cityId" onchange="setCityId()" placeholder="Select City" required="required"></select>
...
<div class="form-group">
	<label class="control-label col-sm-2" for="location">Location:<span style="color:red;">*</span></b></label>
		<div class="col-sm-3">
...
<div class="form-group">
	<label class="control-label col-sm-2" for="pincode">Pincode:<span style="color:red;">*</span></b></label>
		<div class="col-sm-3">
			<input type="text" class="form-control" id="pincode" name="pincode" placeholder="Enter pincode" required="required">
...
<div class="modal-content">
   ...
   <div class="modal-header" style="background-color: #438EB9; color: #fff; width: 725px;">
	   <button type="button" class="close" data-dismiss="modal">&times;</button>
			 <h4 class="modal-title">Client Details</h4>
	</div>

<div class="modal-body" style="background-color: #E5E4E2; float: left; width: 725px;">
	<div class="container">
		<div class="col-md-7">
				  ...
				  <div class="row">
					  <div>
							<div id="user-profile-1" class="user-profile row">
									<div class="col-xs-4 col-sm-3 center" style="top: 20px; float: left:400px">
										<div class="space-6"></div>
											<div style="margin:auto;">
												<span class="profile-picture" id="image" style="width:auto;"></span>
				...
				<div class='row'>
                    <div class="col-sm-12" style='background-color:#848482; color:#fff; border:1px solid lightgray; box-shadow:5px 5px 5px lightgray;'>
		                  <label><strong>Client Name:</strong></label>
							    <span class="editable" id="CLientName"></span> <br/>
									<label><strong>Description:</strong></label>
										<span class="editable" id="desc"></span><br/>
											<label><strong>Company Level:</strong></label>
												<span class="editable" id="company_level_id"></span><br/>
					</div>
			   </div>    
                                                   <br/><div class='row' id="viewAddress"></div>
				...
				<div class='row' >
					<div class='col-sm-3'>
						<br/>
									...
									<input type="file" class="form-control"  style='width:151px; '>
	...
	//validation for country
		...
		$("#more_pincode").on('blur',function(){
				...
				if(!reg.test(val)){
					 ...
					 $('#more_pincode_msg').html("Pincode must contain 6 digit only");
				...
				var clientId= $(this).attr("cId");
					 ...
					 $.ajax({
							...
							success:function(obj){
								...
								/* $("#contact_person_mail_id").html(obj[ind][1].contactPresonNameEmail);
								$("#locations").html(obj[ind][2].location);
								$("#pincode2").html(obj[ind][2].pincode);
								$("#City").html(obj[ind][4].city);
								$("#State").html(obj[ind][5].state);
								$("#Country").html(obj[ind][6].country); */
								}
...
/*             Modal for edit details of client when edit button is clicked              */
 /* ***************************************************************************************/
					...
					var clientId= $(this).attr("cIdEdit");
						...
						$("#hid").val(clientId);
						 $.ajax({
								...
								/* image.src=obj[0][0].clientImage; */
									$("#Client_name").val(obj[0][0].clientName);
									
									$("#description").val(obj[0][0].clientDescription);
								    $("#Level_Id").val(obj[0][3].levelId);
								  									
									//$("#countryId").val(obj[0][6].countryId);
									//$("#stateId").val(obj[0][5].stateId);
									//$("#cityId").val(obj[0][4].cityId);
	 ...
	 $("#Edit_Client_form input[type=file]").change(function(){ 
		...
		/*  "<img  style='width:100px' src='"+obj[0][0].clientImage+"'/>" */
		...
		$.ajax({
			   ...
			   success:function(data){
						...
						if(data[0]!=0){
							...
							//$('#addAllAddress').append("<div class='row' style='padding:3%;'><div class='col-sm-12' style='text-align:right;'></div></div>");
							//$('#msgDiv').html("<div class='alert alert-danger'><h4 style='text-align:center;'>This client is already exist.</h4></div>");
							for(var ind=0; ind<data[1].length; ind++){
...
<script>
	 function myEditFunction(){
			...
			/*  $("#img").change(function(){ 
				 readImage($("#Edit_form input[type=file]").eq(0)).done(function(base64Data){ 
					 alert(base64Data); 
				 $("#img-hid").val(base64Data);
				 */
				 ...
				 // condition ***** all fields are mandetory
				 if($('#Client_name_msg').html()=="This is invalid" || $('#description_msg').html()=="This is invalid" ||  
						 $('#Level_Id_msg').html()=="This is invalid" ) {
				 alert("Please fill all the currect deatils");
				 }
				
					 else{
						 alert("All fields are correct, press ok");
   ...
   if( $('#country1').val()!=-1 && $('#state1').val()!=-1 && $('#city1').val()!=-1 )
     { 
	 var addAdrressData=$("#AddMoreAddrs_form").serialize();
	 //alert(addAdrressData);
