...
<html>
<head>
<center><h3>Technical Team<hr/></h3></center>
...
<!-- Trigger the modal with a button -->
  <div class="col-md-12"><button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Add Technical Team</button>
<hr/></div>
</div>
</div>
...
<div class="row" style="background-color:#E5E4E2; padding:5px; height:auto; text-align:center;">
  ...
  <div class="col-md-3"><label>Arvind</label></div>
  <div class="col-md-3"><label>Technical</label></div>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Create User Form Page</h4>
      </div>
...
{
$('#main-container').html('<img src="../../images/technicalTeamImage.jpg">');
});
</script>
