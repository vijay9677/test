...
<html>
<head>
<center><h3>HR Department<hr/></h3></center>
...
<!-- Trigger the modal with a button -->
  <div class="col-md-12"><button type="button" class="btn btn-info" data-toggle="modal" data-target="#myModal">Add HR Department</button>
<hr/></div>
</div>
</div>
...
<div class="row" style="background-color:#E5E4E2; padding:5px; height:auto; text-align:center;">
  ...
  <div class="col-md-3"><label>Somya</label></div>
  <div class="col-md-3"><label>HR</label></div>
