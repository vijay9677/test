...
<label class="block clearfix"> <span
														class="block input-icon input-icon-right"> <b>Stream:<span style="color:red;">*</span></b><select
															id="stream" name="pgStrem" class='form-control'
															required="reqiured">
														...
														class="block input-icon input-icon-right"> <b>Year
																Of Pass:<span style="color:red;">*</span></b><select name="pgPassing" required="required"
															class='form-control'><option disable selected>Select
																...
																int graduationPassing=graduationDetailsBean.getYearOfPass();
																int postGraduationPassing=graduationPassing+2;
							for(int i=postGraduationPassing;i<=year;i++){
								%>
																<option><%=i %></option>
																<% 
							}
							%>
														...
														class="block input-icon input-icon-right"> <b>Percentage:<span style="color:red;">*</span></b><input
															type="text" placeholder="Eg-60.45" name="pgPercentage"
													...
													<label class="block clearfix"> <span
														class="block input-icon input-icon-right"> <b>University:<span style="color:red;">*</span></b><select
															id="univ" name="pgUniv" class='form-control'>
													...
													<label class="block clearfix"> <span
														class="block input-icon input-icon-right"> <b>College:<span style="color:red;">*</span></b><select
															id="college" name="pgCollege" class='form-control'>
													...
													<label class="block clearfix" style='color: blue'>
														...
														class="block input-icon input-icon-right"> <b>Country:<span style="color:red;">*</span></b><select
															name="pgCountry" id="country" class='form-control'
														...
														class="block input-icon input-icon-right"> <b>State:<span style="color:red;">*</span></b><select
															name="pgState" id='state' class='form-control'
															required="required">
														...
														class="block input-icon input-icon-right"> <b>City:</b><select
															class='form-control' name="pgCity" id='city'
															required="required">
                                     ...
                                     <a href="<%= application.getContextPath()%>/jsp\student\CourseInfoRegistration.jsp"  class="width-25 pull-right btn btn-sm btn-primary"role="button" aria-pressed="true">Skip<i class="ace-icon fa fa-arrow-right icon-on-right"></i></a>
												</div>
											</form>
...
$('document').ready(function(){
				 $("#univ").change(function(){
					...
					if(uid==0){
						$('#college-div').hide();
							$('#add-Univ').html("<b><span style='color:green'>Enter University:</span><span style='color:red'>*</span><b><input type='text' class='form-control'required='required' name='pgaddUniv'>");
							
							$('#add-College').html("<b><span style='color:green'>Enter College:</span><span style='color:red'>*</span><b><input type='text' class='form-control'required='required' name='pgaddCollege'>");
					}
					else if(uid!=0){
						$('#add-Univ').empty();	
						$('#add-College').empty();
