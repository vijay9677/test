...
/**
 * @author ARVIND KUMAR Batch35 This Action Is To getRole for Admin Gives Json
 * 			Response Servlet implementation class GetRoleByAdminAction
 */
@WebServlet("/GetRoleByAdminAction")
public class GetRoleByAdminAction extends HttpServlet implements Servlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetRoleByAdminAction() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.setContentType("text/json");
	        ...
	        try {
				List<RoleDTO> getRole = adminDelegate.getRoleByAdmin();
				Gson gson= new Gson();
				String roleJson = gson.toJson(getRole);
