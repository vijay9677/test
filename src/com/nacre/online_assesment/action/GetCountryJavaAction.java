...
/**
 * @authors Srikanth and krunal B35. This Action Is To get All countryes
 */
@WebServlet("/GetCountryJavaAction.admin")
public class GetCountryJavaAction extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetCountryJavaAction() {
		super();
